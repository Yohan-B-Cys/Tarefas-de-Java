...
public class SistemaAcademico {
	...
	public void cancelarMatricula(Aluno aluno , Disciplina disciplina){
		...
		} else System.out.println("Aluno não está nessa turma");
		
		return;  
	}
	
	public void ListaDeAlunoseDisciplinas() {
	    ...
	    for (Aluno a : alunos) {
	        ...
	        if (!temMatricula) {
	            System.out.print("Nenhuma disciplina vinculada.");
	        }
	        System.out.println(); // Pula linha para o próximo aluno
	    }
	    System.out.println("=========================================================\n");
	}
	...
	public void imprimeProfessoresDisciplinas() {
		...
		if (!temDisciplina) {
			System.out.println("Nenhuma Disciplina lecionada");
		}	
		System.out.println();
		}
		System.out.println("---------------------------------------------------------");
