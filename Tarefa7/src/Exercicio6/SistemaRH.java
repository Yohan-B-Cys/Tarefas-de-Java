...
public class SistemaRH {
	...
	public static String imprimeRelatorio(List<Funcionario> lista) {
	    ...
	    for (Funcionario f : lista) {
	        ...
	        if (f instanceof Gerente) {
	            ...
	            infoExtra = "NÂO DE NEM AGUA" ;
	        }


	        // Na linha, embutimos o "R$" dentro da largura da coluna
	...
	public static void main(String[] args) {
        ...
        try {
        	 Gerente gt = new Gerente("Bruno", 5000.0, ti , 3);
		} catch (Exception e) {
			System.out.println("[ERRO]" + e.getMessage() );
		}
        try {Diretor dt = new Diretor("alfredo", 12000.0, rh , 1);
        ...
        Gerente g1 = new Gerente("Thiago", 5000.0, ti , 5);
        Gerente g2 = new Gerente("Lucas", 5000.0, ti , 5);
        ...
        } catch(RegraNegocioRHException e) {
